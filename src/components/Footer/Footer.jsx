...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#0d081f] text-white py-8 px-[12vw] md:px-[7vw] lg:px-[20vw]">
        ...
        <div className="flex flex-wrap justify-center space-x-4 mt-6">
          {socialLinks.map((item, index) => (
            <a
              ...
              className="text-xl text-gray-300 hover:text-purple-500 transition-transform transform hover:scale-110"
            >
              {item.icon}
            </a>
          ))}
